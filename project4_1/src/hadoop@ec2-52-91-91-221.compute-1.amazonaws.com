...
public class Ngram {
	...
	public static String handleContent(String line) throws ParserConfigurationException, SAXException, IOException {
		...
		content = content.replaceAll("(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]", " ")
				.replaceAll(String.format("<ref((\\s+)%s=(('[^']*')|(\"[^\"]*\")))*/?>|</ref>", regex_attr_xml), " ")
				.toLowerCase()
				.replaceAll("[^a-z']", " ")
				.replaceAll("[^a-z]+'[^a-z]+", " ")
				.replaceAll("\\s+", " ")
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.exit(job.waitForCompletion(true) ? 0 : 1);
	  ...
	  /*
	  String xmlString = "<page><title>Theatre in Louisiana</title><ns>0</ns><id>10408106</id><revision><id>732358840</id><parentid>704917736</parentid><timestamp>2016-07-31T12:29:53Z</timestamp><contributor><username>Colonies Chris</username><id>577301</id></contributor><minor /><comment>minor fixes using [[Project:AWB|AWB]]</comment><model>wikitext</model><format>text/x-wiki</format><text xml:space=\"preserve\">{{UStheater}}There are many famous '''theaters in [[Louisiana]]''', most notably in [[New Orleans]].==Abbeville==* [[Abbey Players (Abbeville)|Abbey Players]]==Alexandria==* [[Coughlin-Saunders Performing Arts Center]]* [[Hearn Stage at The Kress Theatre]]* [[Rapides Opera House]]==Baton Rouge==* [[Baton Rouge River Center Theater for Performing Arts]]* [[Greek Theatre (Baton Rouge)|Greek Theatre]]* [[Reilly Theatre]]* [[Shaw Center for the Arts Manship Theatre]]==Hammond==* [[Columbia Theatre for the Performing Arts]]==Metairie==* [[Jefferson Performing Arts Center (Louisiana)|Jefferson Performing Arts Center]]==New Orleans==* [[Anthony Bean Community Theater]]* [[Carver Theater (New Orleans)|Carver Theater]]* [[Civic Theatre (New Orleans)|Civic Theatre]]* [[Joy Theater]]* [[Le Petit Theatre du Vieux Carre]]* [[Mahalia Jackson Theater of the Performing Arts]]* [[Orpheum Theatre (New Orleans)|Orpheum Theatre]]* [[Saenger Theatre (New Orleans)|Saenger Theatre]]* [[State Palace Theatre (New Orleans)|State Palace Theatre]]==Shreveport==* [[RiverView Theater (Shreveport, Louisiana)|RiverView Theater]]* [[Shreveport Municipal Memorial Auditorium]]==St. Martinville==* [[Duchamp Opera House]]==Thibodaux==* [[Thibodaux Playhouse, Inc.]]{{coord missing|Louisiana}}[[Category:Theatres in Louisiana]]{{theat-stub}} &lt;ref&gt;{{cite web|title=Major Waterfalls|url=http://www.keralatourism.org/wayanad/waterfalls-wayanad.php}} &lt;/ref&gt; </text><sha1>7z66ggf2xllinij2krsh385bz0wbh6v</sha1></revision></page>";
